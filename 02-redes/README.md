...
## O projeto tem como objetivo reforçar conceitos de redes em nuvem:
* segmentação de tráfego segurança
* automação de deploy
* simulando um cenário real de arquitetura corporativa em múltiplas zonas de disponibilidade.
